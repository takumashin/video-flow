...
export default function AccountBalance() {
  ...
  return (
    <div className="group relative">
      ...
      <div className="pointer-events-none absolute right-0 top-full z-[120] mt-2 hidden w-64 rounded-lg border border-border bg-surface p-3 text-xs shadow-lg group-hover:pointer-events-auto group-hover:block group-focus-within:pointer-events-auto group-focus-within:block">
        <div className="flex items-center justify-between gap-2">
          ...
          <button
            ...
            className="pointer-events-auto rounded p-1 text-muted hover:bg-surface-muted hover:text-foreground"
            aria-label="刷新余额"
          >
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="pointer-events-auto mt-2 inline-flex items-center gap-1 text-primary-light hover:underline"
        >
          打开费用中心
